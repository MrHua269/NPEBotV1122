...
public class MCForgeHandShakeV2 extends MCForgeHandShake {
    ...
    public void handle(Packet recvPacket) {
        ClientPluginMessagePacket packet = (ClientPluginMessagePacket) recvPacket;
            ...
            switch (packetID) {
                case Packet_S2CModList: {
                    ...
                    */
                    ...
                    reply(packet.getChannel(), targetNetworkReceiver, buf.toByteArray());
                    break;
                }
    ...
    private void reply(String id, String targetNetworkReceiver, byte[] payload) throws IOException {
        forge.session.send(new ServerPluginMessagePacket(id, new LoginWrapper(targetNetworkReceiver, payload).toBytes()));
    }
